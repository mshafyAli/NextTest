        ...
        <div className="flex flex-col md:gap-20 gap-4 lg:flex-row items-center justify-center py-8  text-white ">
          ...
          <div className="lg:w-[40%] mb-10 text-center lg:text-left">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Get Your Article Ready To Be Published With Us
            </h2>
            <p className="text-sm mb-6">
              Watch your article published among the most reputable academic
              writers by contacting us now and getting our article writing
              services for publication purposes
            </p>
