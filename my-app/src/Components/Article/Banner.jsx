        ...
        <div className="md:w-[80%] w-[95%] mx-auto px-4 md:py-10 py-6">
          <div className="flex flex-col items-start md:flex-row gap-12 md:gap-20 lg:gap-20">
            ...
            <div className="md:w-[50%] w-full">
              ...
              <p className="whitespace-pre-wrap text-black pt-4 text-sm  font-medium">Structured abstract! Clear methods! Detailed results! Our article writing service effectively meets the journal standards for complete publication support.</p>
