          ...
          <div className="flex flex-col items-start md:flex-row gap-12 md:gap-20 lg:gap-20">
            ...
            <div className="text-white  md:w-[65%]">
              ...
              <p className="whitespace-pre-wrap py-4 text-sm  font-medium">
                Discover the best coursework help service in UK! Whether you
                need someone to do my coursework or require assistance with
                coursework details, our expert coursework writers are here to
                help. Pay to do my coursework and experience top-quality
                assistance tailored to your academic needs. Trust us for
                reliable and professional coursework help!
              </p>
