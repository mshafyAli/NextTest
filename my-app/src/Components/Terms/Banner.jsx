        ...
        <div className="p-8 space-y-8">
          <section>
            <p className=" text-gray-700">
              ...
              <Link href="/">
                {" "}
                <span className="text-green">researchpublishinghouse.com</span>
              </Link>{" "}
          ...
          <section>
            ...
            <div className="mt-6">
              ...
              <p className="mt-2 text-gray-700">
                ...
                to you is owned by RPH. We will transfer all copyrights to you
            ...
            <div className="mt-6">
              ...
              <p className="mt-2 text-gray-700">
                RPH shall not be liable for any damage of any sort if the
