  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://be.researchpublishinghouse.com/api/signup.php",
        data,
        {
          headers: {
  ...
  return (
    <div className="bg-darkBlue w-full h-auto  my-12">
      <div className="md:w-[80%] w-[90%] mx-auto">
        <div className="flex flex-col md:gap-20 gap-4 lg:flex-row items-center justify-center py-8  text-white ">
          {/* Left Section */}
          <div className="lg:w-[45%] mb-10 text-center lg:text-left">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Contact Now For Top-quality Manuscript Writing Assistance
            </h2>
            <p className="text-sm mb-6">
              Quality with reliability! A combo that is not found very often but
              we are here with it. So; place your order now for manuscript
              writing help and watch your content among the best works.
            </p>
          ...
          <div className="lg:w-[30%] bg-white text-secondary py-6 px-6 rounded-xl">
            <h3 className="text-2xl font-semibold mb-4">
              Get up to <span className="text-green font-bold">50%</span> OFF on
              first order
            </h3>
