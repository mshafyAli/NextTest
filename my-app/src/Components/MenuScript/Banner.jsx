        ...
        <div className="md:w-[80%] w-[95%] mx-auto px-4 md:py-10 py-6">
          <div className="flex flex-col items-start md:flex-row gap-12 md:gap-20 lg:gap-20">
            ...
            <div className="md:w-[50%] w-full">
              ...
              <p className="whitespace-pre-wrap text-black pt-4 text-sm  font-medium">
                Our manuscript writers align your manuscript with the target
                audience and scope to make sure that your work is categorized
                under its specific type.
              </p>
              ...
              <div className="flex gap-2 items-center pt-4">
                ...
                <h1 className="text-secondary">
                  We are Trusted By 40K+ Clients Worldwide &{" "}
