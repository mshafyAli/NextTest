...
const Banner = () => {
  ...
  const items = [
    {
      title:
        "Guaranteeing Your Article’s Publication With Our Research Publishing House Assistance",
      subTitle:
        "You are in the right place at the right time for rightful acclaim! With our Research Publishing House assistance, you’ve got the best chances to get your article published.",
      src: "/slide1.webp",
    },
    {
      title: "Form A Structured Abstract With Our Research Publishing House  Journal Publication Assistance",
      subTitle:
        "Our expert editors condense your exceptional research work into an engaging abstract while following the IMRAD structure.",
      src: "/slide2.webp",
    },
    {
      title:
        "Best  Publication Assistance Aligned With Journal Policies",
      subTitle:
        "We offer complete professional Research Publishing House assistance while ensuring that supplementary materials and data-sharing options align with the journal’s policies.",
      src: "/slide3.webp",
    },
  ];
