          ...
          <div className="flex flex-col items-start md:flex-row gap-12 md:gap-20 lg:gap-20">
            ...
            <div className="text-white  md:w-[65%]">
              <h1 className="text-white font-medium text-xl  uppercase">
                GET YOUR ASSIGNMENTS DONE - 24/7 SUPPORT
              </h1>
              ...
              <p className="whitespace-pre-wrap py-4 text-sm  font-medium">
                Original Assignments with Timely Submissions! With us, you don’t
                need to stress over those deadlines! With our tailor made
                assignments delivered before date, you will get straight A
                without any effort.
              </p>
