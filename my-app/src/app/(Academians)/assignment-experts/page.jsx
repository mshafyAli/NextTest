...
import Banner from '@/Components/AssignmentExperts/Banner';

// Dynamically import components
const About = dynamic(() => import('@/Components/AssignmentExperts/About'));
...
const AssignmentExpertPage = () => {
  ...
  useEffect(() => {
    document.title = 'Assignment Experts - The Academians UK Ltd.';
  }, []); 
  ...
  return (
    <div>
      <Head>
        <title>Assignment Experts - The Academians UK Ltd.</title>
      </Head>
      <Top />
