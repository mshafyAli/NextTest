...
const OrderNowPage = () => {
  ...
  useEffect(() => {
    const fetchLastOrderNumber = async () => {
      try {
        const response = await axios.get(`http://localhost/php-backend/api/last-order-number.php`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`http://localhost/php-backend/api/order-now.php`, orderData);
